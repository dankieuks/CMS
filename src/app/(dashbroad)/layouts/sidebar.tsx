...
const Sidebar = ({ children }: Readonly<{ children: React.ReactNode }>) => {
    ...
    return (
        <Layout className='!min-h-screen'>
            <Sider trigger={null} collapsible collapsed={collapsed} width={300} className='bg-slate-200 relative'>
                <div className='flex '><Image src={logo} alt='' />
                    <Button
                        type="text"
            ...
            <Layout className='!bg-neutral-200'>
                <Content className='!bg-transparent  p-5' >
                    {children}
                </Content>
            </Layout>
        </Layout>
